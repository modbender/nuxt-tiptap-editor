    ...
    return new Plugin({
        props: {
            ...
            handleDrop(view: EditorView, event: DragEvent) {
                return (
                    plugin?.setView(view).handleDrop(event as DragEvent) ||
          || false
                )
            },
        },
            ...
            apply(tr, _value, _oldState, newState) {
                ...
                if (filesOrUrls) {
                    const arr: Array<File | string> =
                        typeof filesOrUrls === 'string' ||
                        filesOrUrls instanceof File
                            ? [filesOrUrls]
